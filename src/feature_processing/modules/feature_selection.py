...
class EDMFeatureSelector:
    ...
    - ensemble: classic multi-criteria scoring (ANOVA, MI, RF, ET, variance, separation)
    - greedy: forward selection maximizing silhouette coefficient
    - hybrid: greedy selection + top ensemble features for balanced quality
    """
    ...
    def hybrid_select(self, X, y, n_greedy=20, n_ensemble_extra=5, 
        ...
        ensemble_selector = EDMFeatureSelector(n_features=50, random_state=self.random_state)
