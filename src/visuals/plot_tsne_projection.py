...
def get_natural_clusters(X_selected, n_clusters):
    ...
    Features are already Yeo-Johnson scaled from the pipeline.
    """
    print(f"\nComputing {n_clusters} natural clusters...")
    
    # No extra scaling needed — data is already Yeo-Johnson transformed
    kmeans = KMeans(
...
def plot_tsne_consistent_colors(X_selected, natural_labels, y_true, save_path='tsne_comparison.png'):
    ...
    # Optionally, add cluster boundaries or centroids to show the 23 clusters
    ...
    fig.text(0.5, 0.02, 
            f'Key Finding: Music naturally forms 23 acoustic families, but industry uses 35 genre labels',
...
if __name__ == "__main__":
    try:
        ...
        print("  - This script")
        print("  - dataset/top100_with_tempogram_nmf_meta.csv")
