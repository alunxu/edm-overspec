...
from visuals.visualization import (
    ...
    plot_genre_convergence_heatmap, plot_cluster_genre_mapping
)
...
def run_complete_analysis():
    ...
    # 4. Hybrid Feature Selection (20 greedy + 5 ensemble = 25 features)
    selector = EDMFeatureSelector(random_state=42)
    X_selected = selector.hybrid_select(
        X_dedup, y, 
        n_greedy=20, n_ensemble_extra=5, 
    ...
    # Plot cluster to genre mapping
    mapping_matrix, mapping_matrix_norm = plot_cluster_genre_mapping(natural_labels, y.values)
