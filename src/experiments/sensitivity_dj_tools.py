...
for metric_key, metric_name, ax in metric_info:
    ...
    ax.axvline(x=20, color='#2b5ea7', linestyle=':', alpha=0.8, linewidth=1.5,
               label='All 35: Consensus $k=20$')
    ax.axvline(x=17, color='#c44e2e', linestyle=':', alpha=0.8, linewidth=1.5,
               label='Excl. DJ: Consensus $k=17$')
    
    # Shade the 17-20 plateau region
    ax.axvspan(17, 20, color='#e5e7eb', alpha=0.3, zorder=1, label='17–20 Plateau')
...
outpath = 'paper/SMC/figs/paper/figa3_sensitivity_dj_tools.png'
