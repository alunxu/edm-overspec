...
\begin{document}
	...
	\begin{figure}[t]
		...
		\caption{Acoustic archetypes of the purest versus most hybridized clusters. Each vertex aggregates z-normalized features into one of six macro-dimensions, scaled to 0--100 via $p_5$/$p_{95}$ interpolation. Pure clusters (e.g., DJ Tools, Ambient) localize at feature extremes, highlighting highly specialized production constraints, whereas hybrid mainstream clusters exhibit moderate, overlapping acoustic profiles.}
		\label{fig:profiles}
	\end{figure}
